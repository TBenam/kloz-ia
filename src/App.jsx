...
import {
  ...
  Smartphone, BarChart3, Clock, Link, Calendar, Check, Star, User
} from 'lucide-react';
...
const WhatsAppProof = () => (
  <div className="bg-white text-slate-900 rounded-3xl overflow-hidden shadow-2xl max-w-sm mx-auto border-4 border-slate-800 relative">
    {/* Header WhatsApp */}
    ...
    <div className="bg-[#E5DDD5] p-4 h-64 flex flex-col gap-3 text-sm font-sans relative">
      ...
      <div className="self-end bg-[#DCF8C6] p-2 px-3 rounded-lg rounded-tr-none shadow-sm max-w-[85%] z-10">
      ...
      <div className="self-start bg-white p-2 px-3 rounded-lg rounded-tl-none shadow-sm max-w-[85%] z-10">
  ...
  <div className="min-h-screen bg-slate-950 text-white selection:bg-indigo-500/30 font-sans overflow-x-hidden">
    ...
    <nav className="fixed w-full z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <button 
          onClick={onStartDemo}
          className="bg-white text-slate-950 px-5 py-2.5 rounded-full text-sm font-bold hover:bg-indigo-50 transition-all flex items-center gap-2 shadow-lg shadow-white/10"
        >
    ...
    <section className="pt-32 pb-20 px-6 relative overflow-hidden">
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-indigo-600/20 rounded-full blur-[120px] -z-10" />
      ...
      <div className="max-w-5xl mx-auto text-center animate-fade-in-up">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button className="w-full sm:w-auto px-8 py-4 rounded-full font-bold text-lg text-slate-300 border border-slate-700 hover:bg-slate-800 transition-all flex items-center justify-center gap-2">
        ...
        <div className="mt-20 pt-10 border-t border-slate-800/50">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 hover:opacity-100 transition-opacity duration-500">
            <div className="flex items-center gap-2 font-bold text-2xl text-slate-300"><span className="p-2 bg-[#25D366]/20 rounded-full text-[#25D366]"><Smartphone className="w-6 h-6"/></span> WhatsApp</div>
            <div className="flex items-center gap-2 font-bold text-2xl text-slate-300"><span className="p-2 bg-[#0084FF]/20 rounded-full text-[#0084FF]"><Facebook className="w-6 h-6"/></span> Messenger</div>
            <div className="flex items-center gap-2 font-bold text-2xl text-slate-300"><span className="p-2 bg-[#E1306C]/20 rounded-full text-[#E1306C]"><Instagram className="w-6 h-6"/></span> Instagram</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="story" className="py-24 bg-slate-900 border-y border-slate-800">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-8 text-lg text-slate-300 leading-relaxed font-light">
          ...
          <div className="bg-indigo-900/20 border border-indigo-500/30 p-8 rounded-2xl mt-12 relative overflow-hidden">
    ...
    <footer className="py-10 border-t border-slate-900 text-center text-slate-600 text-sm bg-slate-950">
      <p>&copy; 2024 KlozIA Solutions. Propulsé par Gemini 2.5 Flash.</p>
    </footer>
  </div>
);
...
export default function App() {
  ...
  return (
    <>
      {currentView === 'home' ? (
        <LandingPage onStartDemo={() => setCurrentView('app')} />
      ) : (
